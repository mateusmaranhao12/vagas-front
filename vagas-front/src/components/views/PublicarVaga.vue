      ...
      salvarVaga() {
        ...
        if (this.validaFormulario()) {
          ...
          this.emitter.emit('alerta', {
            ...
            descricao: 'A vaga foi cadastrada e poderá ser consultada por milhares de profissionais em nossa plataforma!'
          })
          ...
          this.emitter.emit('alerta', {
            ...
            descricao: 'Parece que você esquecer de preencher alguma informação, faça o ajuste e tente novamente...'
          })
